...
def main():
    ...
    mode_eregion = dict(n_bauds=13, tx_pulse_length=650000, ipp=2000000)
    ...
    mode_fregion = dict(n_bauds=1, tx_pulse_length=480000, ipp=8200000)
    ...
    mode_topside = dict(n_bauds=1, tx_pulse_length=1000000, ipp=16400000)
